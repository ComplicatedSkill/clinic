...
@section('page-title', isset($patients)?'Edit Patient':'Create Patient')
@section('page-subtitle') <a href=" {{url('patient')}}">Patient</a>@endsection
@section('subtitle',isset($patients)?'Edit Patient':'Create Patient')
@section('content')
    @if(session('message'))
                                ...
                                <select class="custom-select" name="department_id" required>
                                    @foreach ($departments as  $departments)
                                        <option value="{{$departments->department_id}}"
                                                ​​​ {{isset($staffs) && $staffs->department_id==$departments->department_id?'selected':''}}>{{$departments->department_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
