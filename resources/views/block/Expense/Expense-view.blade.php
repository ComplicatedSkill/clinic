...
@section('page-title', 'Operating Expense')
@section('page-subtitle') <a href=" {{url('/home')}}">Dashboard</a>@endsection
@section('subtitle', 'Operating Expense')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                    ...
                    <form action="/search_user" method="get">
                        ...
                        <div class="mb-3 float-right">
                            <button type="button" class="btn btn-primary btn-md"
                                    onclick="window.location='{{ url('/Expense')}}'">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form role="form" id="createform"
                                              action="{{action('ExpenseController@store')}}"
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach ($expenses as $expense)
                                        <tr role="row" class="odd">
                                            <td>{{$no++}}</td>
                                            <td>{{$expense -> branchs -> branch_name}}</td>
                                            <td>{{$expense -> chartAccounts -> chart_account_name_kh}}</td>
                                            <td>{{$expense -> date}}</td>
                                            ...
                                            <td>
                                                <a href="{{ route('Expense.edit',$expense->operating_expense_id) }}"
                                                   class="btn btn-primary btn-sm"> <i
                                                        class="fa fa-edit"></i></a>
                                                <button type="button" class="btn btn-danger btn-sm btn_delete"
                                                        name="btnDelete"
                                                        onclick="delete_expense({{$expense->operating_expense_id}})">
